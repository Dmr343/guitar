...
T.describe('cagedShapeFor G mayor', () => {
  // Standard CAGED barre positions for G:
  // E-shape: G is 3 semitones above E  → barre 3
  // A-shape: G is 10 semitones above A → barre 10
  // G-shape: G is 0 above G → open position, shown as 12
  // C-shape: G is 7 semitones above C  → barre 7  (plan had typo: listed 5)
  // D-shape: G is 5 semitones above D  → barre 5  (plan had typo: listed 7)
